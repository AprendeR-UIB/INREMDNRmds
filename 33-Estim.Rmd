# (PART\*) Tema V: Estadística inferencial  {-}
...
```{block2, type="rmdnote"}
La función `sd` (de *standard deviation*) calcula la desviación típica **muestral**, con denominador $\sqrt{n-1}$. Para calcular la desviación típica de verdad, con denominador $\sqrt{n}$ hay que multiplicarla por $\sqrt{n-1}$ y dividirla por $\sqrt{n}$.
```
...
knitr::include_graphics("INREMDN_files/figure-html/JAMOVIdem1.png")
```
...
```{r, echo=FALSE,out.width="90%"}
knitr::include_graphics("INREMDN_files/figure-html/JAMOVIdem2.png")
```
...
Para R, la distribución t de Student es `t`, a secas. La tenéis también en el módulo **distrACTION**.


```{r, echo=FALSE,out.width="90%"}
knitr::include_graphics("INREMDN_files/figure-html/JAMOVIdem3.png")
```
...
**(4)** Sobre una muestra de 100 mujeres  se obtuvo una concentración media de hemoglobina de 10 con una desviación típica de 2. ¿Qué vale el error típico de la muestra (para la media muestral, se entiende)? 
...
**(8)** El 0.75-cuantil de una variable t de Student con 49 grados de libertad $T$ vale 0.68. ¿Cuál de las afirmaciones siguientes es verdadera? 

1. $P(T\leqslant 0.75)= 0.68$
1. $P(T\geqslant 0.75)= 0.68$
1. $P(T\leqslant 0.68)= 0.75$ 
1. $P(T\geqslant 0.68)= 0.75$
1. $P(T= 0.68)= 0.75$
1. $P(T= 0.75)= 0.68$
1. Ninguna de las otras respuestas es correcta.

**(9)** Sabemos que una determinada variable poblacional $X$ sigue una distribución normal de media 2. ¿Cuál de las afirmaciones siguientes es verdadera? 

1. El porcentaje de individuos de la población en los que la $X$ vale 2 es del 50%
1. El porcentaje de individuos de la población en los que la $X$ vale menos de 1 es del 70%
1. Si el 0.95-cuantil de $X$ es 3, el 0.05-cuantil de $X$ es 1 
1. Si el 0.95-cuantil de $X$ es 3, el 0.05-cuantil de $X$ es -3
1. Todas las otras afirmaciones son falsas

**(10)** ¿Qué es el error típico de la proporción muestral?  

1. La varianza de la distribución de las proporciones muestrales.
1. La diferencia entre su valor sobre una muestra aleatoria simple y el valor real de la probabilidad poblacional de éxito.
1. La desviación típica de la distribución de las proporciones muestrales. 
1. La probabilidad que su valor sobre una muestra aleatoria simple sea diferente de la probabilidad poblacional de éxito.
1. La diferencia entre su valor esperado y el valor real de la probabilidad poblacional de éxito.

**(11)** ¿Cuál de las afirmaciones siguientes es FALSA?  

1. La media muestral es un estimador insesgado de la media poblacional
1. La proporción muestral es un estimador insesgado de la proporción poblacional
1. La varianza muestral es un estimador insesgado de la varianza poblacional
1. La desviación típica muestral es un estimador insesgado de la desviación típica poblacional
1. Alguna de las afirmaciones anteriores es falsa.
