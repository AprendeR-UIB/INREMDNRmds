...
```{r,echo=FALSE}
knitr::include_graphics("INREMDN_files/figure-html/arearosa.png")
```
...
* $f_X(x)$ no es una probabilidad, y por lo tanto puede ser mayor que 1. Por ejemplo, el gráfico siguiente muestra la densidad de una variable normal $N(0,0.01)$ (véase la Sección \@ref(sec:normal)), que llega  a valer casi 40. Pero el área bajo toda la curva densidad es 1: a partir de $\pm 0.06$ la densidad vale prácticamente 0.

```{r,echo=FALSE,out.width="60%",fig.asp=1,fig.width=5}
curve(dnorm(x,0,0.01),xlim=c(-0.06,0.06),xlab="",ylab="",main="Densidad de N(0,0.01)")
```
...
O podéis usar JAMOVI, R o alguna aplicación para móvil o tablet. 


```{r, echo=FALSE,out.width="90%"}
knitr::include_graphics("INREMDN_files/figure-html/jamovinorm.png")
```




Para R, la normal es `norm`. Así, por ejemplo, si $X$ es $N(1,2)$
...
```{r jamovinorm1,echo=FALSE,out.width="100%"}
knitr::include_graphics("INREMDN_files/figure-html/JAMOVI.norm.1.png")
```
...
```{r jamovinorm2,echo=FALSE,out.width="100%"}
knitr::include_graphics("INREMDN_files/figure-html/JAMOVI.norm.2.png")
```
...
**(4)** En una variable aleatoria continua, su función de densidad  (marca una única respuesta):
...
**(8)** ¿Qué distribución es la más adecuada para modelar el número anual de fallecimientos entre enfermos de cáncer tratados con una determinada quimioterapia si estas se producen al azar? Marca una única respuesta.
...
**(11)** En un estudio clínico, se midió el nivel de glucosa en sangre en un grupo muy grande de personas de una determinada población y a partir del mismo se estimó el intervalo de referencia del 95% para este nivel de glucosa en esta población. ¿Cuál es la interpretación correcta de este intervalo?

1. Es un intervalo que contiene el 95% de los valores medios del nivel de glucosa en muestras de sujetos de esta población del mismo tamaño que la usada

1. Es un intervalo que tiene una probabilidad del 95% de contener el nivel de glucosa en sangre del 95% de esta población

1. Es un intervalo que contiene el nivel de glucosa en sangre del 95% de las personas de esta población

1. Es un intervalo que, para cada persona  de esta población, contiene su nivel de glucosa en sangre en el 95% de las ocasiones que se lo medimos 

1.  Ninguna de las otras respuestas es correcta


**(12)** El 0.975-cuantil de la altura de las niñas recién nacidas es 0.53 metros. ¿Qué significa esto? 

1.  Que un 97.5% de las niñas recién nacidas miden exactamente 0.53 metros

1. Que un 97.5% de las niñas recién nacidas miden alrededor de 0.53 metros

1. Que un 97.5% de las niñas recién nacidas miden 0.53 metros o menos

1. Que un 97.5% de las niñas recién nacidas miden 0.53 metros o más
