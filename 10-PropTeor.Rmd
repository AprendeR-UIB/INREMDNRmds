...
```{block2,type="rmdnote"}
Podéis ejecutar las funciones de R que iremos dando en estas notas en la ventana del editor de R de JAMOVI. Para tener acceso a ella, tenéis que instalar el módulo Rj (pulsando en el signo + de la esquina superior derecha de la ventana de JAMOVI y navegando entre las diferentes oopciones).
```
...
```{r jamoviR1,echo=FALSE,out.width="100%", fig.cap="La ventana de edición de R" }
knitr::include_graphics("INREMDN_files/figure-html/jamoviR1.png")
```
