...
& =0.001\cdot 0.115+0.003\cdot 0.654+0.007\cdot 0.191=`r round(0.001* 0.115+0.003* 0.654+0.007* 0.191,4)`\sim `r 100*round(0.001* 0.115+0.003* 0.654+0.007* 0.191,3),4)`%
\end{array}
$$
...
$$
\begin{array}{l|c|c|c|}
 & A & A^c & \text{Total}\\ \hline
 B & \only<3>{495}& \only<3>{4975} &   \\ \hline
 B^c & &   & \\ \hline
\text{Total} &  \only<1>{\hphantom{500}}\only<2,3>{500} & \only<1>{\hphantom{99500}}\only<2,3>{99500} & 100000\\ \hline
\end{array}
$$
...
\text{Total} & 500 & 99500 & 10000\\ \hline
\end{array}
$$
...
\begin{array}{l|c|c|c|}
 ...
 \text{Total} &  \only<1>{\hphantom{2000}}\only<2,3,4,5>{2000} & \only<1>{\hphantom{98000}}\only<2,3,4,5>{98000} & 100000\\ \hline
\end{array}
$$
...
\text{Total} &  2000 & 98000 & 100000\\ \hline
\end{array}
$$
\begin{enumerate}
...
\begin{array}{l|c|c|c|}
 ...
 T^c & &   & 85000 \\ \hline
\text{Total} &  \only<1,2,3,4,5,6,7>{x}  & \only<1,2,3,4,5,6,7>{100000-x} & 100000\\ \hline
\end{array}
$$
\pause\pause
$$
