...
Esto es una edición en línea de los apuntes de *Introducción a la Investigación en Salud y Bioestadística* del grado de Medicina de la UIB. El libro está escrito en *R Markdown*, usando *RStudio* como editor de textos y el paquete **bookdown** para convertir los ficheros *markdown* en un libro. En la presente versión se ha usado la versión 4.3.3 de R y la versión 2.3.28.0 de JAMOVI para macOS.
