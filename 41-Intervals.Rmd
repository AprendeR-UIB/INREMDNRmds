...
```{r}
library(epitools) #Para cargar las funciones del paquete
binom.exact(0,20)
```
...
Vamos a calcular un IC-95% para $\mu_h-\mu_m$. Como ambas muestras son grandes, vamos a usar una fórmula basada en la t de Student. Tenemos los datos siguientes:
