...
Sea $p$ la prevalencia de la COVID-19 en un momento y población dados. Sea p la prevalencia de la COVID-19 en un momento y población dados. Dadas 10 muestras tomadas en ese momento en esa población, ¿cuál es el valor esperado de tests que se tienen que realizar? Para p pequeña, del orden del 5%, ¿significaría el pooling un ahorro considerable de tests?

**Plan**: Considerad la variable aleatoria que cuenta, para cada conjunto de 10 muestras, cuántos tests se realizan. 

a. ¿Cuál es su dominio? 

b. ¿Qué vale la probabilidad de cada elemento del dominio? (es  decir, la densidad de la variable aleatoria)

c. ¿Cuál es su valor esperado?

d. ¿Qué vale este valor esperado cuando p es 5%?
...
$$
    De hecho, la probabilidad de alguna repetición en una muestra aleatoria simple de 100 españoles es 0.0001, es  decir, de media solo se da alguna repetición en una de cada 10000 muestras de estas, como muestra la aplicación siguiente de la función `pbirthday`:
    

```{r}
pbirthday(100,46700000)
```
...
Cada vez que repitamos esta instrucción seguramente obtendremos una muestra aleatoria diferente:
```{r}
rhyper(25,5,45,10)
rhyper(25,5,45,10)
rhyper(25,5,45,10)
...
1. Lanzamos un dado cúbico; si sale un resultado par, lanzamos una moneda equilibrada 5 veces y contamos el número de caras, y si sale un resultado impar,  lanzamos la moneda  equilibrada 10 veces  y contamos el número de caras. 
...
1. El peso de una persona elegida al azar. 
1. El número de casos diarios de gripe en Mallorca. 
1. El número de glóbulos rojos en 1 mm^3^ de sangre. 
1. La proporción de hipertensos en una muestra aleatoria de 50 individuos. 
1. Escogemos 10 estudiantes diferentes en una clase de 20, y contamos cuántas mujeres han salido. 
1. Ninguna de ellas.

**(6)** Sean $X$ e $Y$ dos variables aleatorias discretas cualesquiera. ¿Cuál o cuáles  de las afirmaciones siguientes son verdaderas?
