...
* Se evitan preferencias en la elección, por lo que es más probable que la muestra sea representativa de la población (pero, naturalmente, no está garantizado: por pura mala pata nos puede salir una muestra super rara, es lo que tiene el azar).
...
Por lo que refiere a los tamaños de las muestras de cada estrato, se suel optar por una de las dos estrategias siguientes: 
...
los investigadores tenían que tomar una muestra de adolescentes de San Lepoldo (Brasil). Para ello:
