...
Si no se va con cuidado, los estudios de casos y controles (y en general todos los estudios observacionales) son muy susceptibles al efecto de confundidores. Un **confundidor** es una característica asociada con la exposición que puede causar la enfermedad. 
...
```{block2,type="rmdexercici"}
En un [estudio llevado a cabo en 1928](https://journals.sagepub.com/doi/abs/10.3181/00379727-26-4143?journalCode=ebma), R. Pearl quiso contrastar la hipótesis de que la tuberculosis previene el cáncer. Para ello, de un grupo de 7500 autopsias realizadas entre pacientes fallecidos en un hospital concreto, identificó todos los pacientes que tenían cáncer en el momento de fallecer. En total, fueron 816. A continuación,  seleccionó  al azar de entre los restantes otro grupo de 816 pacientes, emparejados con los cancerosos por edades, raza y sexo. Encontró que un 6.6% de los enfermos de cáncer y un 16.3% de los sujetos del otro grupo tenían tuberculosis en el momento de fallecer.
...
* Los sujetos que **participan** en el estudio y que forman la muestra que se estudia: los sujetos a los que se administran (o no) los diferentes tratamientos.
...
a. ¿Creéis que la conclusión de Gregg estaba justificada en base a los datos de los 78 neonatos con cataratas? En caso positivo, ¿por qué? En caso negativo, ¿qué información haría falta para poder llegar a una conclusión?
...
```{r ensayosclinicos,echo=FALSE, out.width="80%",fig.cap="Fases de los ensayos farmacológicos; fuente: https://clinicalinfo.hiv.gov/es/glossary/ensayo-clinico"}
