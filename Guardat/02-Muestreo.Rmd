...
Un **sesgo** es cualquier tipo de error sistemático en el diseño o la ejecución de un estudio que pueda afectar la corrección de las conclusiones obtenidas. Por ejemplo, si en un estudio transversal sobre hipertensión usamos un esfigmomanómetro que sistemáticamente mide una presión arterial  más alta que la real, se produce un sesgo: se detectará una prevalencia mayor de hipertensos que la real. No se ha de confundir con el error aleatorio inherente a las mediciones (por ejemplo, los debidos a la medición imprecisa del esfigmomanómetro o a la variación natural  de la presión arterial en un individuo a lo largo del día).

Muchos autores han producido listas larguísimas de tipos de sesgo que muestran la creatividad de los humanos a la hora de cometer errores y de ponerles nombres a los mismos. Aquí vamos a introducir algunos de los más comunes.

1. **Sesgo de selección**: Cuando la muestra no es representativa de la población objetivo. Por ejemplo: queremos saber la incidencia del cáncer de pecho en una comunidad y para ello tomamos una muestra de solo hombres. Hay varios subtipos que vale la pena distinguir:

    a. **Sesgo de selección diferencial**: Cuando el sesgo de selección de produce de manera diferente en los diferentes grupos de sujetos considerados. Por ejemplo: nos preguntamos sobre la influencia de algunos factores de riesgo en la diabetes, y tomamos como casos diabéticos hospitalizados y como controles personas sanas que no están hospitalizadas (a este tipo de sesgo en concreto, tomar como casos solo casos hospitalizados, se le llama **sesgo de Berkson}). 
