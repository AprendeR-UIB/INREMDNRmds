...
Los resultados de un metaanálisis se suelen representar mediante un **forest plot** (o también **diagrama de efectos** o **blobograma**) como el de la Figura \@ref(fig:blob), que ya  explicaremos con más detalle en el Tema \@ref(chap:IC) sobre Intervalos de Confianza.
