...
```{r jamoviedo1,echo=FALSE,out.width="100%"}
knitr::include_graphics("INREMDN_files/figure-html/JAMOVI.EDO.1.png")
```
...
* `apply(..., MARGIN=1, FUN=cumsum)` aplica la función `cumsum`, que calcula sumas acumuladas, por filas a la tabla entrada en los puntos suspensivos.
