...
En este caso, se toma una muestra aleatoria de un tamaño prefijado de cada estrato (en el sentido de la Sección \@ref(sec:mas))  y se unen en una muestra global. Este proceso es llamado **muestreo aleatorio estratificado**.  
