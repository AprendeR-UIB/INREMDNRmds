...
```{block2,type="rmdimportant"}
¡Cuidado con cómo os expresáis! El riesgo de EPOC entre los no fumadores es del 6.4% y entre los fumadores es del 17.8%. Por lo tanto, el riesgo entre los fumadores es **11.4 puntos porcentuales mayor** que entre los no fumadores. Los RA se expresan en puntos porcentuales.
...
* **Número necesario para tratar** (**NNT**): El número de pacientes que deberían empezar a recibir el tratamiento $T$ (en lugar del control $T^c$) para que, de media, un paciente **adicional** recibiera el beneficio (pasara de $E$ a $E^c$).
