...
\end{array}
$$
Miden para la densidad de la variable lo que medían los de la muestra: el coeficiente de asimetría, si es simétrica o si tiene cola a algún lado; el coeficiente de curtosis, si es más apuntada o más plana que una campana de Gauss. 
...
La gráfica de la densidad de una variable aleatoria normal es la famosa **campana de Gauss** de la que hemos hablado varias veces:
