...
\draw (0,0) node[preg] (P2) {\small\sf ¿Asigna el investigador\\ \small\sf la exposición\\ \small\sf a propósito?};  
...
\draw (-2,-4.5) node[tract] (B2) {\small \sf Tratamiento A};  
\draw (2,-4.5) node[tract] (A2) {\small \sf Tratamiento B};  
\draw[->] (O)--(I);
\draw[->] (O)--(II);
\draw[->] (I)--(A1);
\draw[->] (II)--(B1);
