...
Para ir calentando motores, vamos a describir brevemente la estructura habitual de un estudio médico, y lo ilustraremos con el artículo ["Marcha nórdica para prevención cardiovascular en pacientes con cardiopatía isquémica crónica o síndrome metabólico"](https://www.sciencedirect.com/science/article/pii/S0025775316305024) (*Medicina Clínica* 147 (2016), pp. 537-539) que tendríais que ir consultando en paralelo con esta sección.
...
* Estudio **casi-experimental**: Todos los otros. Por ejemplo, el estudio sobre marcha nórdica que usábamos en la Sección \@ref(sec:pasos)  es casi-experimental, puesto que no hay un grupo de control, solo el grupo a los que se "administró" marcha nórdica durante un año.
