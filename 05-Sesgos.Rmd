...
Un **sesgo** es cualquier tipo de error sistemático en el diseño o la ejecución de un estudio que desplace en algún sentido los datos recogidos (en el total de la muestra o en un subgrupo de la misma), es decir, que los **sesgue**,  y pueda afectar las conclusiones obtenidas. Por ejemplo, si en un estudio transversal sobre hipertensión usamos un esfigmomanómetro que sistemáticamente mide una presión arterial más alta que la real, se produce un sesgo: se detectará una prevalencia mayor de hipertensos que la real. 
...
2. **Sesgo de medida**: Se produce cuando el método de medición de características de los sujetos es defectuoso en una dirección concreta. Incluye, por ejemplo:
